    ...
    <>
      <nav className="navbar navbar-expand-lg pl-2">
        ...
        <Link to="/" className="navbar-brand logo pl-4">
            <img src={i18n.language === 'en' ? `${process.env.REACT_APP_BASE_URL}assets/images/kh-logo.png` : `${process.env.REACT_APP_BASE_URL}assets/images/kh-logo-rtl.png`} alt="Logo" className='logo' />
          </Link>
          <button
