...
function Signup() {
    ...
    const url='http://localhost/khadim-hazir/api/createUser';
    ...
    <div class="row justify-content-center">
      ...
      <input class="form-check-input m-4  " type="radio" name="usertype" id="radio1" value="employee" onChange={handleChange}/>
        <div class="form-check form-check-inline">
          ...
          <Link><img src="assets/images/labour.png" alt="" class=" labour"/></Link>
          <label>Labour</label>
          </div>
        </div>
        <input class="form-check-input m-4" type="radio" name="usertype" id="radio2" value="employer" onChange={handleChange}/>
        <div class="form-check form-check-inline pr-5">
         
          <div class="row .redio-buttons-image">
          <Link ><img src="assets/images/employee.png" alt="" class=" labour"/></Link>
        ...
        if (user.usertype === "employee") {
          return (
            ...
            {category.map(categories => ( <option>{categories.name}</option>))}
            </select>
            </div>
          </div>
          )
