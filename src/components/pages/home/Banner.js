      ...
      <div className="row">
        <div className="col-md-6">
          <div className="item header-text">
            ...
            <p className="pera-banner">"If you are looking for talented and dedicated workers to join your team. Look no further! Khadim Hazir is your ultimate destination for finding top-notch professionals who are ready to contribute to your company's success."</p>
