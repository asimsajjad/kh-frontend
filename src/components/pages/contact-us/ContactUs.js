              ...
              <form onSubmit={handleSubmit}> 
                ...
                <div className="row">
                  <div  className={i18n.language === 'en' ? 'col-12 text-left mt-3' : 'col-12 text-right mt-3'}>
                    ...
                    <textarea className="form-control" name="comments" id="floatingTextarea2" placeholder={t("question1")} value={contact.comments} onChange={handleChange} required ></textarea>
                  </div>              
                </div>
                <SubmitButton/>
              </form>
